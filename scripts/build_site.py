...
<footer class="w-full bg-gray-900 text-white mt-auto">
  <div class="max-w-7xl mx-auto px-6 py-10 text-center space-y-5">
    <div>
      <a href="https://x.com/intent/tweet?text=Book%20rec%20for%20%40PEoperator%3A%20%5Btitle%5D%20%E2%80%94%20why%3A%20%E2%80%A6%20%E2%80%94%20from%20%40"
      ...
      <p class="mt-3 text-sm text-gray-400">Tweet a rec to @PEoperator — include your @handle</p>
    </div>
